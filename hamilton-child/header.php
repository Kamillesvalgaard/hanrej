...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<head>
<script id="mcjs">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/314c9cfc71be3af8ff1a991c8/6a5a5d1c8744cdda7cf3190e7.js");</script>
	...
	<body <?php body_class(); ?>>
        ...
        <header class="section-inner site-header">
			...
			<<?php echo $site_title_elem; ?> class="site-title">
				...
				<?php else : ?>
					<a href="https://kamillesvalgaard.com/kea/4sem/Hanrej/forside/" class="site-name"><?php echo $site_title; ?></a>
				<?php endif; ?>
